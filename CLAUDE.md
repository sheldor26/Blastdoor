...
A snapshot of your working tree taken the moment before a coding agent runs something destructive, and a way back.

## Stack in one line

Node 18+, ESM, zero dependencies, git plumbing — details in [ARCHITECTURE.md](ARCHITECTURE.md).
