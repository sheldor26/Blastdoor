/**
 * Writing the hook into .claude/settings.json without trampling what is there.
 *
...
export function install(path, command) {
  ...
  settings.hooks.PreToolUse = [...others, entry(command)];
